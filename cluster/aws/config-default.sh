...
DEPLOY_SH=${DEPLOY_SH:-https://raw.githubusercontent.com/RobBickel/CentOs-7.4-friendly-KuberDock-Install/master/deploy.sh}
ZONE=${KUBE_AWS_ZONE:-us-west-2b}
MASTER_SIZE=${MASTER_SIZE:-}
NODE_SIZE=${NODE_SIZE:-}
NUM_NODES=${NUM_NODES:-2}
NODE_TYPES=${KUBE_AWS_NODE_TYPES:-}
...
MASTER_ROOT_DISK_SIZE=${MASTER_ROOT_DISK_SIZE:-15}
...
NODE_NAME="${INSTANCE_PREFIX}-minion"
NODE_SCOPES=""
